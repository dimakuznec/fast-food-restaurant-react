				...
				<div className='container'>
					...
					{formActive && (
						...
						>
							...
							<ul className='buy-now-form-modal-window-list__product'>
								<li className='buy-now-form-modal-window-row__product'>
									<div className='buy-now-img-prod-pic__product'>
										<img src='../imgs/chocolate-bar.png' alt='' />
									</div>
									<button className='buy-now-img-btg__product'>
										<span className='buy-now-img-span__product'>100 g</span>
									</button>
								</li>
								<li className='buy-now-form-modal-window-row__product'>
									<div className='buy-now-img-prod-pic__product'>
										<img src='../imgs/ChocolateBonbonMilk.png' alt='' />
									</div>
									<button className='buy-now-img-btg__product'>
										<span className='buy-now-img-span__product'>200 g</span>
									</button>
								</li>
								<li className='buy-now-form-modal-window-row__product'>
									<div className='buy-now-img-prod-pic__product'>
										<img src='../imgs/chocolate-bar-dark.png' alt='' />
									</div>
									<button className='buy-now-img-btg__product'>
										<span className='buy-now-img-span__product'>300 g</span>
									</button>
								</li>
							</ul>
